<template>
    <div>
      <header data-am-widget="header" class="am-header am-header-default header">
        ...
        <h1 class="am-header-title"> <a href="javascript:;" class="" style="color: #333;">厨房妈妈</a></h1>
    ...
    <div class="page zShow" id="couponDetail" refresh="0" style="background: rgb(255, 103, 103);">
        <div class="coupon-wrap">
            <img  class="logo"  src="../assets/images/default_photo.png" />
            <p class="name">厨房妈妈</p>
            ...
            <div class="contact-wrap">
                <p class="address">地址 : <span>北 京房山区妈妈厨房</span></p>
                <p class="phone">电话 : <span>0736-12345678</span></p>
            </div>
        </div>
        <div class="receive-btn" style="background: rgb(255, 214, 60);">领取</div>
    </div>
    </div>
</template>
